...
namespace DotNetCoreKoans.Koans
{
  public class AboutStrings : Koan
  {
    ...
    public void VerbatimStringsCanHandleMultipleLinesToo()
    {
      ...
      // Expected: I \n\n am a \n\n broken line
      // Actual:   I \n\n am a \n\n broken line
      //             ↑ (pos 2)  IDK WHAT TO DO THEY ARE THE SAME and its doubling my /n's
      //   var iAmCheating = "cheat codes"; no longer needed to pass the test but idk why what im doing worked
