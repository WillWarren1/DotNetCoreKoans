...
namespace DotNetCoreKoans.Koans
{
  ...
  public class AboutMethods : Koan
  {
    ...
    {
      string[] result = { "Cory", "Will", "Corey" }; //borrowing this from sylvana. Is there a better way to do this? you can pretend i retroactively did this to the similar koans in the control statements. I knew the answers but couldnt get it to accept them but going back and changing them to this is like a lot and id rather work on capstone
      Assert.Equal(result, this.MethodWithVariableArguments("Cory", "Will", "Corey"));
    }
    ...
    {
      string[] result = { "Cory", "Will", "Corey" };
      Assert.Equal(result, this.LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
    }
    ...
    {
      string[] result = { "Cory", "Will", "Corey" };
      Assert.Equal(result, LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
    }
